...
public class RemoveGreenScreen{
	...
	public static void main(String[] args){
		...
		try {
			input = ImageIO.read(RemoveGreenScreen.class.getResource("resources/pubgGreenScreen.png"));
		} catch ( IOException e) {
		...
		turnGreenScreenIntoRedScreen(imageAsArray);
	 ...
	 */
	private static void turnGreenScreenIntoRedScreen(int[][] inputArray){
		final int GREEN_CUTOFF = 100;
		final int RED_CUTOFF   = 100;
		final int BLUE_CUTOFF  = 100;
