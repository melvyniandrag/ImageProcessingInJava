...
public class Steganography {
	...
	private static void extractByte(int[][] imageArray, int row, int col, byte[] byteArray, int byteArrIndex) {
		// todo implement me
		// this is here as a placeholder for now! Delete this and write the code correctly!
		try {
			byte[] deleteMeThisIsHereJustSoTheCodeRuns = MESSAGE_TO_HIDE.getBytes("US-ASCII");
			byteArray[byteArrIndex] = deleteMeThisIsHereJustSoTheCodeRuns[byteArrIndex];
